    ...
    >
      <div className="flex items-center gap-3">
        <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center -rotate-6 shadow-lg shadow-white/10">
          <span className="text-black font-black text-2xl rotate-6">P</span>
        </div>
        <span className="text-2xl font-serif tracking-tight text-white">PDF Crawler</span>
      </div>
      ...
      <div className="flex items-center">
        <button className="bg-white text-black px-6 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-[0.2em] hover:bg-zinc-200 transition-all hover:scale-[1.02] active:scale-[0.98]">
          Join
        </button>
      </div>
    </motion.nav>
